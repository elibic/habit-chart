...
export const ELEMENT_DEFS = {
  topic: {
    ...
    textKey: 'topic',
    textLabel: 'הטקסט',
    defaults: { visible: true, x: 50, y: 8.5, scale: 1, bg: null, fg: null, style: 'pill' },
  },
  name: {
    label: 'שם הילד/ה',
    hint: 'הכותרת הגדולה',
    textKey: 'childName',
    textLabel: 'השם',
    defaults: { visible: true, x: 50, y: 17.5, scale: 1, bg: null, fg: null, style: 'plain' },
  },
  dateChip: {
    label: 'כרטיס התאריך',
    hint: 'החודש או הטווח',
    textKey: null,
    defaults: { visible: true, x: 11, y: 13, scale: 1, bg: null, fg: null, style: 'card' },
  },
  plaque: {
    label: 'משפט העידוד',
    hint: 'הכותרת התחתונה',
    textKey: 'plaqueText',
    textLabel: 'הטקסט',
    defaults: { visible: true, x: 50, y: 95, scale: 1, bg: null, fg: null, style: 'pill' },
  },
}
...
/** Position, size and any colour overrides, as inline CSS. */
